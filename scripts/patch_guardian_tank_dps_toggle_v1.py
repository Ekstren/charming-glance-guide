...
GUARDIAN_BLOCK = r'''    Guardian:[
      ...
      role('Dungeon · DPS','Water AoE / fast-clear bruiser',['Swirling Blade','Lunarwater Threads','Seismic Tide','Raging Maelstrom'],['Frigid Aura','Defensive Assault','Frigid Glint','Potential Rebirth'],'Stack Cold quickly, pressure groups with Water AoE, and keep enough single-target damage for elites. If you completely outgear the room, Potential Rebirth → Pursuit of Victory or another damage charm.','Keep enough Block/DEF to stay active; Guardian damage still benefits from staying in the fight.','Prydwen Water core'),
      role('Crucible / Conquest · DPS','Single-target Guardian score build',['Swirling Blade','Lunarwater Threads','Seismic Tide','Star Shattering Slash'],['Frigid Aura','Defensive Assault','Frigid Glint','Pursuit of Victory'],'Keep the three Water Techniques for consistent Cold stacking, then use Star Shattering Slash for the single-target payoff. If a much stronger carry is present, a support-focused Guardian can still raise total team damage more.','Star Shattering Slash is the Paladin/Guardian line’s heavy single-target nuke. If your copy is badly under-ranked versus Raging Maelstrom, dummy-test the two before forcing the swap.','Prydwen ST hybrid + Global testing'),
      role('Arena · DPS','Offensive block / counter bruiser',['Swirling Blade','Luminous Shield','Forceful Charge','Star Shattering Slash'],['Rebound','Holy Aegis','Block Mastery','Eye for an Eye'],'Use Block/Rebound durability while spending the flex slots on real kill pressure. If Pandarial and your ranks support it, Luminous Shield → Light Sword Array for a more aggressive setup; keep Block stats high.','If the opponent can burst through you, Eye for an Eye → Soul Protection or Potential Rebirth before changing the whole bar.','Prydwen + PvP'),
      ...
      role('Tournament · 4v4 · DPS','Water AoE team-pressure build',['Swirling Blade','Lunarwater Threads','Seismic Tide','Raging Maelstrom'],['Frigid Aura','Defensive Assault','Frigid Glint','Potential Rebirth'],'Four enemy bodies give the Water/Cold setup plenty of opportunities to stack Cold and spread pressure. If your team already has a frontline and you are not being focused, Potential Rebirth → Pursuit of Victory for more damage.','If your team lacks a frontline, use the Tank setup instead.','Prydwen Water + team-PvP logic')
    ]'''
