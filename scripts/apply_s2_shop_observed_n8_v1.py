...
new_block = r'''  // CG_S2_SHOP_OBSERVED_N8_V1
  // Charming Glance S2 shop averages measured from eight untouched full shop pages.
...
pattern = r"  // CG_S2_SHOP_OBSERVED_N(?:4|7|8)_V1\n.*?(?=\n  function applyS2ScoringStartDefaults\(\))"
...
method_replacement = (
    ...
    'The current sample is <b>8 untouched full shop pages</b>: average <b>2,887.5 Raw Ore</b>, <b>2,343.8 Battle Essence</b>, '
    '<b>975 regular Chrono Sand</b>, <b>183.8 Rare Chrono Sand</b>, and <b>200.6 Basic Treats</b> per page. '
    'Rare Chrono Sand remains separate in the sample data and is converted at <b>5 regular Sand per Rare Sand</b> only when the optimizer needs a single Sand-equivalent total, giving <b>1,893.8 Sand-equivalent per page</b> at the current n=8 average. '
...
for needle in [
    'CG_S2_SHOP_OBSERVED_N8_V1',
    'Object.freeze({ore:1350,essence:1800,sand:0,rareSand:330,treat:510})',
    'sand:a.sand+a.rareSand*SAND_BLUE_EQ',
    '8 untouched full shop pages',
    '1,893.8 Sand-equivalent per page'
]:
    if needle not in s:
        raise SystemExit(f'Missing expected n8 shop marker: {needle}')

path.write_text(s, encoding='utf-8')
print('Applied Charming Glance S2 observed shop averages (n=8).')
