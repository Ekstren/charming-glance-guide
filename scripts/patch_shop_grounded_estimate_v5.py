...
oldp='''<p><b>Daily Shop estimate:</b> in both S1 and S2, until a trustworthy shop slot/drop-rate table is available, the optional shop planner uses a deliberately simple material-only estimate of <b>~700 Ore, ~900 Skill Essence, ~600 Chrono Sand and ~50 Basic Treats per refresh</b>. The default is 0 refreshes/day; users opt in to the number they actually buy. Only future server-reset days are projected; the current day is excluded so materials already represented in the Saved fields are not double-counted. This does not value non-material shop rolls or estimate the Rolla cost of buying them.</p>'''
