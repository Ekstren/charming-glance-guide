...
new_block = r'''  // CG_S2_SHOP_OBSERVED_N9_V1
  // Charming Glance S2 shop averages measured from nine untouched full shop pages.
...
pattern = r"  // CG_S2_SHOP_OBSERVED_N(?:4|7|8|9)_V1\n.*?(?=\n  function applyS2ScoringStartDefaults\(\))"
...
method_replacement = (
    ...
    'The current sample is <b>9 untouched full shop pages</b>: average <b>2,750 Raw Ore</b>, <b>2,400 Battle Essence</b>, '
    '<b>866.7 regular Chrono Sand</b>, <b>230 Rare Chrono Sand</b>, and <b>198.3 Basic Treats</b> per page. '
    'Rare Chrono Sand remains separate in the sample data and is converted at <b>5 regular Sand per Rare Sand</b> only when the optimizer needs a single Sand-equivalent total, giving <b>2,016.7 Sand-equivalent per page</b> at the current n=9 average. '
...
for needle in [
    'CG_S2_SHOP_OBSERVED_N9_V1',
    'Object.freeze({ore:1650,essence:2850,sand:0,rareSand:600,treat:180})',
    'sand:a.sand+a.rareSand*SAND_BLUE_EQ',
    '9 untouched full shop pages',
    '2,016.7 Sand-equivalent per page'
]:
    if needle not in s:
        raise SystemExit(f'Missing expected n9 shop marker: {needle}')

path.write_text(s, encoding='utf-8')
print('Applied Charming Glance S2 observed shop averages (n=9).')
