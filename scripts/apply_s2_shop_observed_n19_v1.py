...
new_block = r'''  // CG_S2_SHOP_OBSERVED_N19_V1
...
pattern = r"  // CG_S2_SHOP_OBSERVED_N(?:4|7|8|9|10|11|15|19)_V1\n.*?(?=\n  function applyS2ScoringStartDefaults\(\))"
...
method_replacement = (
    ...
    'The current sample is <b>19 observed shop pages</b>: average <b>2,534.2 Raw Ore</b>, <b>1,792.1 Battle Essence</b>, '
    '<b>1,744.7 regular Chrono Sand</b>, <b>187.9 Rare Chrono Sand</b>, and <b>198.2 Basic Treats</b> per page. '
    'Rare Chrono Sand remains separate in the sample data and is converted at <b>5 regular Sand per Rare Sand</b> only when the optimizer needs a single Sand-equivalent total, giving <b>2,684.2 Sand-equivalent per page</b> at the current n=19 average. '
...
for needle in [
    ...
    'Object.freeze({ore:1350,essence:0,sand:3150,rareSand:300,treat:245})',
    'sand:a.sand+a.rareSand*SAND_BLUE_EQ',
    '19 observed shop pages',
    '2,534.2 Raw Ore',
    '1,792.1 Battle Essence',
    '1,744.7 regular Chrono Sand',
    '187.9 Rare Chrono Sand',
    '198.2 Basic Treats',
    '2,684.2 Sand-equivalent per page'
]:
    if needle not in s:
        raise SystemExit(f'Missing expected n19 shop marker: {needle}')

path.write_text(s, encoding='utf-8')
print('Applied Charming Glance S2 observed shop averages (n=19).')
