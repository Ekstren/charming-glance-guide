...
new_block = r'''  // CG_S2_SHOP_OBSERVED_N11_V1
  // Charming Glance S2 shop averages measured from eleven untouched full shop pages.
...
pattern = r"  // CG_S2_SHOP_OBSERVED_N(?:4|7|8|9|10|11)_V1\n.*?(?=\n  function applyS2ScoringStartDefaults\(\))"
...
method_replacement = (
    ...
    'The current sample is <b>11 untouched full shop pages</b>: average <b>2,645.5 Raw Ore</b>, <b>2,468.2 Battle Essence</b>, '
    '<b>1,104.5 regular Chrono Sand</b>, <b>188.2 Rare Chrono Sand</b>, and <b>184.5 Basic Treats</b> per page. '
    'Rare Chrono Sand remains separate in the sample data and is converted at <b>5 regular Sand per Rare Sand</b> only when the optimizer needs a single Sand-equivalent total, giving <b>2,045.5 Sand-equivalent per page</b> at the current n=11 average. '
...
for needle in [
    'CG_S2_SHOP_OBSERVED_N11_V1',
    'Object.freeze({ore:1350,essence:3150,sand:2850,rareSand:0,treat:110})',
    'sand:a.sand+a.rareSand*SAND_BLUE_EQ',
    '11 untouched full shop pages',
    '2,645.5 Raw Ore',
    '2,468.2 Battle Essence',
    '1,104.5 regular Chrono Sand',
    '188.2 Rare Chrono Sand',
    '184.5 Basic Treats',
    '2,045.5 Sand-equivalent per page'
]:
    if needle not in s:
        raise SystemExit(f'Missing expected n11 shop marker: {needle}')

path.write_text(s, encoding='utf-8')
print('Applied Charming Glance S2 observed shop averages (n=11).')
