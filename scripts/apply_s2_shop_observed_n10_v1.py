...
new_block = r'''  // CG_S2_SHOP_OBSERVED_N10_V1
  // Charming Glance S2 shop averages measured from ten untouched full shop pages.
...
pattern = r"  // CG_S2_SHOP_OBSERVED_N(?:4|7|8|9|10)_V1\n.*?(?=\n  function applyS2ScoringStartDefaults\(\))"
...
method_replacement = (
    ...
    'The current sample is <b>10 untouched full shop pages</b>: average <b>2,775 Raw Ore</b>, <b>2,400 Battle Essence</b>, '
    '<b>930 regular Chrono Sand</b>, <b>207 Rare Chrono Sand</b>, and <b>192 Basic Treats</b> per page. '
    'Rare Chrono Sand remains separate in the sample data and is converted at <b>5 regular Sand per Rare Sand</b> only when the optimizer needs a single Sand-equivalent total, giving <b>1,965 Sand-equivalent per page</b> at the current n=10 average. '
...
for needle in [
    'CG_S2_SHOP_OBSERVED_N10_V1',
    'Object.freeze({ore:3000,essence:2400,sand:1500,rareSand:0,treat:135})',
    'sand:a.sand+a.rareSand*SAND_BLUE_EQ',
    '10 untouched full shop pages',
    '1,965 Sand-equivalent per page'
]:
    if needle not in s:
        raise SystemExit(f'Missing expected n10 shop marker: {needle}')

path.write_text(s, encoding='utf-8')
print('Applied Charming Glance S2 observed shop averages (n=10).')
