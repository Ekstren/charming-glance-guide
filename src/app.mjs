...
import { pacificLocalMs, pacificIsoAt, nextPacificResetMs, countFuturePacificResets, isoAddDays } from './time.mjs';
...
async function solveTargetWithAutoStaminaCooperative(baseScore,desired,p,baseResources,cfg=activeCalcConfig(),job=null){
  ...
  loadState();
  setupNavigation({ $, setSection, saveState, updateThemeButton });
